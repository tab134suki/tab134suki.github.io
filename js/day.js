...
l=["震惊！微软让Minecraft Java免费了！","北斗七星跑南极去了","太阳打西边出来了","今天居然不是愚人节","你作业写完了！！！","Minecraft竟然违背Mojang的原则发布2.0！","非常抱歉，因为不可控原因，博客将于明天停止运营，再见","好消息，日本没了！","美国垮了，背后原因竟是时刻心心念念想着祖国的川普！","微软垮了！"]
console.log(m,dd);
...
if(m==7&&dd==5){//建党节
    console.log("UP主"+(y-2007).toString()+"岁生日快乐");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("up主"+(y-2007).toString()+"岁生日快乐");
        sessionStorage.setItem("isPopupWindow","1");
    }
}
...
if(m==12&&dd==20){
    ...
    document.getElementsByTagName("html")[0].setAttribute("style","filter: grayscale(100%);");
    if(sessionStorage.getItem("isPopupWindow")!="1"){
        Swal.fire("今天是1937年12月20日卢沟桥事变"+(y-1937).toString()+"周年纪念日。\n勿忘国耻，振兴中华！");
        sessionStorage.setItem("isPopupWindow","1");
    }    
}